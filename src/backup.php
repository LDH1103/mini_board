...
<body>
    ...
    <form class="body_form" method="post" action="board_update.php">
		...
		<input class="input_title" type="text" name="board_title" id="title" value="<?php echo $result_info["board_title"] ?>">
		<br>
		<label for="contents"></label>
		<textarea class="input_contents" name="board_contents" id="contents"><?php echo $result_info["board_contents"] ?></textarea>
		<br>
